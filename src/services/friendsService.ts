...
export const sendFriendRequest      = (to: string, message?: string) => api.post("/api/ecosystem/friends/request", { to, message }).then(r => r.data);
...
export const getFriends             = () => api.get("/api/ecosystem/friends").then(r => r.data);
